...
namespace Week10_1.Persistence.Migrations.Identity
{
    ...
    [Migration("20231206212245_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Week10_1.Domain.Identity.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("Week10_1.Domain.Identity.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Week10_1.Domain.Identity.User", null)
                        .WithMany()
